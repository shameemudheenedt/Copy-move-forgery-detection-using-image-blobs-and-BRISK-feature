...
if __name__=='__main__':
	i = 0
	images = [image for image in glob.glob('C:/Users/Computer Science Lap/Downloads/MICC-F8multi/DSCF0018_scale_tampered_multi_ire2.jpg')]
	for im in images:
